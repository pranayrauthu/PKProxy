...
var _OptionsList = __webpack_require__(35);

var _OptionsList2 = _interopRequireDefault(_OptionsList);

var _OptionForm = __webpack_require__(34);
...
var App = function App(props) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_OptionForm2.default, null),
        _react2.default.createElement("hr", null),
        _react2.default.createElement(_OptionsList2.default, null)
    );
};
...
var optionsReducer = function optionsReducer() {
    var store = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultStore.options;
    var action = arguments[1];

    switch (action.type) {
        case "ADD_OPTION":
            return [].concat(_toConsumableArray(store), [action.option]);
        case "DELETE_OPTION":
            return store.filter(function (o, i) {
                return !(i == action.index);
            });
        case "UPDATE_OPTION":
            return store.map(function (opt, i) {
...
var formReducer = function formReducer() {
    var store = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultStore.formState;
    var action = arguments[1];
...
var rootReducer = (0, _redux.combineReducers)({ options: optionsReducer, formState: formReducer });
var optionsStore = (0, _redux.createStore)(rootReducer);
...
var OptionForm = function (_React$Component) {
    ...
    function OptionForm(props) {
        ...
        _this.addOptionToStore = _this.addOptionToStore.bind(_this);
        return _this;
    }
    ...
    _createClass(OptionForm, [{
        ...
        key: 'addOptionToStore',
        value: function addOptionToStore(e) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: (0, _classnames2.default)("mdl-textfield", "mdl-js-textfield") },
                    ...
                    _react2.default.createElement(
                        'label',
                        { className: (0, _classnames2.default)("mdl-textfield__label"), htmlFor: "sample2" },
                        'Index'
                    ),
                    _react2.default.createElement(
                        'span',
                        { className: (0, _classnames2.default)("mdl-textfield__error") },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'label',
                        { className: (0, _classnames2.default)("mdl-textfield__label"), htmlFor: "filterUrl" },
                        'URL to intercept'
                    )
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'label',
                        { className: (0, _classnames2.default)("mdl-textfield__label"), htmlFor: "redirectUrl" },
                        'URL to redirect'
                    )
                ),
                ...
                _react2.default.createElement(
                    ...
                    {
                        id: "add-entry-btn",
                        className: (0, _classnames2.default)("mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent"),
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'a',
                        { href: 'https://developer.chrome.com/apps/match_patterns', target: '_blank' },
                        'rules'
                    ),
                    ' for url patterns.'
                )
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        addEntry: function addEntry(option) {
            var optionToSave = {
        ...
        updateEntry: function updateEntry(option) {
            var filterUrl = option.filterUrl,
                redirectUrl = option.redirectUrl;
            ...
            dispatch({
                ...
                data: {
                    index: index,
                    option: { filterUrl: filterUrl, redirectUrl: redirectUrl }
                }
            });
        },
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(OptionForm);
    ...
    _createClass(OptionsList, [{
        ...
        value: function handleClick(e) {
            ...
            if (target.dataset.type === "edit") {
                var option = this.props.options.filter(function (opt, i) {
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { id: "options-table", onClick: this.handleClick },
                this.loadOptions()
            );
        }
    }]);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        ...
        editOption: function editOption(option) {
            ...
            dispatch({
                type: "UPDATE_FORM",
                data: { index: index, filterUrl: filterUrl, redirectUrl: redirectUrl, mode: "EDIT" }
            });
        },
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(OptionsList);
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(13),B=__webpack_require__(4),C=__webpack_require__(2),ba=__webpack_require__(12),da=__webpack_require__(16),ea=__webpack_require__(17),fa=__webpack_require__(14),ia=__webpack_require__(15),D=__webpack_require__(5);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(28), __webpack_require__(74)(module)))
